...
interface KSCrashReportWriter {
  addBooleanElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: boolean) => void
  >;
  addFloatingPointElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: number) => void
  >;
  addIntegerElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: number) => void
  >;
  addUIntegerElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: number) => void
  >;
  addStringElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: string) => void
  >;
  addTextFileElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: string) => void
  >;
  addTextFileLinesElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: string) => void
  >;
  addJSONFileElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: string, p4: boolean) => void
  >;
  addDataElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: string, p4: number) => void
  >;
  beginDataElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string) => void
  >;
  appendDataElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: number) => void
  >;
  endDataElement: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<KSCrashReportWriter>) => void>;
  addUUIDElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: string) => void
  >;
  addJSONElement: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string, p3: string, p4: boolean) => void
  >;
  beginObject: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string) => void
  >;
  beginArray: interop.FunctionReference<
    (p1: interop.Pointer | interop.Reference<KSCrashReportWriter>, p2: string) => void
  >;
...
interface KSJSONDecodeCallbacks {
  onBooleanElement: interop.FunctionReference<
    (p1: string, p2: boolean, p3: interop.Pointer | interop.Reference<any>) => number
  >;
  onFloatingPointElement: interop.FunctionReference<
    (p1: string, p2: number, p3: interop.Pointer | interop.Reference<any>) => number
  >;
  onIntegerElement: interop.FunctionReference<
    (p1: string, p2: number, p3: interop.Pointer | interop.Reference<any>) => number
  >;
  onNullElement: interop.FunctionReference<(p1: string, p2: interop.Pointer | interop.Reference<any>) => number>;
  onStringElement: interop.FunctionReference<
    (p1: string, p2: string, p3: interop.Pointer | interop.Reference<any>) => number
  >;
...
interface KSJSONEncodeContext {
  addJSONData: interop.FunctionReference<
    (p1: string, p2: number, p3: interop.Pointer | interop.Reference<any>) => number
  >;
...
declare function kscpu_i_fillState(
  thread: number,
  state: interop.Pointer | interop.Reference<number>,
  flavor: number,
  stateCount: number
): boolean;
...
declare function kscrash_reportUserException(
  name: string,
  reason: string,
  language: string,
  lineOfCode: string,
...
declare function kscrash_setCrashNotifyCallback(
  onCrashNotify: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<KSCrashReportWriter>) => void>
): void;

declare function kscrash_setDeadlockWatchdogInterval(deadlockWatchdogInterval: number): void;

declare function kscrash_setDoNotIntrospectClasses(
  doNotIntrospectClasses: interop.Pointer | interop.Reference<string>,
  length: number
): void;
...
declare function ksdl_getBinaryImage(
  index: number,
  buffer: interop.Pointer | interop.Reference<KSBinaryImage>
): boolean;
...
declare function ksfu_openBufferedReader(
...
declare function ksfu_openBufferedWriter(
  writer: interop.Pointer | interop.Reference<KSBufferedWriter>,
  path: string,
  writeBuffer: string,
  writeBufferLength: number
): boolean;

declare function ksfu_readBufferedReader(
  reader: interop.Pointer | interop.Reference<KSBufferedReader>,
  dstBuffer: string,
  byteCount: number
): number;
...
declare function ksfu_readEntireFile(
  path: string,
  data: interop.Pointer | interop.Reference<string>,
  length: interop.Pointer | interop.Reference<number>,
  maxLength: number
): boolean;
...
declare function ksfu_writeBufferedWriter(
  writer: interop.Pointer | interop.Reference<KSBufferedWriter>,
  data: string,
  length: number
): boolean;
...
declare function ksjson_addBooleanElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string,
  value: boolean
): number;

declare function ksjson_addDataElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string,
  value: string,
  length: number
...
declare function ksjson_addFloatingPointElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string,
  value: number
): number;

declare function ksjson_addIntegerElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string,
  value: number
): number;
...
declare function ksjson_addJSONFromFile(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string,
  filename: string,
  closeLastContainer: boolean
...
declare function ksjson_addNullElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string
): number;

declare function ksjson_addRawJSONData(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  data: string,
  length: number
): number;

declare function ksjson_addStringElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string,
  value: string,
  length: number
...
declare function ksjson_appendDataElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  value: string,
  length: number
): number;

declare function ksjson_appendStringElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  value: string,
  length: number
): number;

declare function ksjson_beginArray(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string
): number;

declare function ksjson_beginDataElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string
): number;

declare function ksjson_beginElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string
): number;
...
declare function ksjson_beginObject(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string
): number;

declare function ksjson_beginStringElement(
  context: interop.Pointer | interop.Reference<KSJSONEncodeContext>,
  name: string
): number;
...
declare function ksmem_copyMaxPossible(
  src: interop.Pointer | interop.Reference<any>,
  dst: interop.Pointer | interop.Reference<any>,
  byteCount: number
): number;

declare function ksmem_copySafely(
  src: interop.Pointer | interop.Reference<any>,
  dst: interop.Pointer | interop.Reference<any>,
  byteCount: number
): boolean;
...
declare function ksobjc_arrayContents(
  arrayPtr: interop.Pointer | interop.Reference<any>,
  contents: interop.Pointer | interop.Reference<number>,
  count: number
): number;

declare function ksobjc_arrayCount(arrayPtr: interop.Pointer | interop.Reference<any>): number;

declare function ksobjc_baseClass(
  classPtr: interop.Pointer | interop.Reference<any>
...
declare function ksobjc_copyStringContents(
  string: interop.Pointer | interop.Reference<any>,
  dst: string,
  maxLength: number
): number;

declare function ksobjc_copyURLContents(
  nsurl: interop.Pointer | interop.Reference<any>,
  dst: string,
  maxLength: number
): number;
...
declare function ksobjc_getDescription(
...
declare function ksobjc_isaPointer(
  objectOrClassPtr: interop.Pointer | interop.Reference<any>
): interop.Pointer | interop.Reference<any>;

declare function ksobjc_ivarCount(classPtr: interop.Pointer | interop.Reference<any>): number;

declare function ksobjc_ivarList(
  classPtr: interop.Pointer | interop.Reference<any>,
  dstIvars: interop.Pointer | interop.Reference<KSObjCIvar>,
  ivarsCount: number
): number;

declare function ksobjc_ivarNamed(
  classPtr: interop.Pointer | interop.Reference<any>,
  name: string,
  dst: interop.Pointer | interop.Reference<KSObjCIvar>
): boolean;

declare function ksobjc_ivarValue(
  objectPtr: interop.Pointer | interop.Reference<any>,
  ivarIndex: number,
  dst: interop.Pointer | interop.Reference<any>
): boolean;
...
declare function ksobjc_superClass(
  classPtr: interop.Pointer | interop.Reference<any>
): interop.Pointer | interop.Reference<any>;
...
declare function kssc_initSelfThread(
  cursor: interop.Pointer | interop.Reference<KSStackCursor>,
  skipEntries: number
): void;
...
declare function ksstring_extractHexValue(
  string: string,
  stringLength: number,
  result: interop.Pointer | interop.Reference<number>
): boolean;

declare function ksstring_isNullTerminatedUTF8String(
  memory: interop.Pointer | interop.Reference<any>,
  minLength: number,
  maxLength: number
): boolean;
