    ...
    export namespace event {
      export namespace interfaces {
        export class HttpInterface {
          ...
          public constructor(
            param0: any /* javaxservlethttpHttpServletRequest */,
            param1: io.sentry.event.helper.RemoteAddressResolver
          );
          public getProtocol(): string;
      ...
      export namespace json {
        export class DebugMetaInterfaceBinding {
          public writeInterface(
            param0: any /* com.fasterxml.jackson.core.JsonGenerator */,
            param1: io.sentry.event.interfaces.SentryInterface
          ): void;
          public writeInterface(
            param0: any /* com.fasterxml.jackson.core.JsonGenerator */,
            param1: io.sentry.event.interfaces.DebugMetaInterface
          ): void;
          public constructor();
        }
      }
    ...
    export namespace marshaller {
      export namespace json {
        export class ExceptionInterfaceBinding {
          ...
          public writeInterface(
            param0: any /* com.fasterxml.jackson.core.JsonGenerator */,
            param1: io.sentry.event.interfaces.ExceptionInterface
          ): void;
        }
      }
    }
    ...
    export namespace marshaller {
      export namespace json {
        export class HttpInterfaceBinding {
          ...
          public writeInterface(
            param0: any /* com.fasterxml.jackson.core.JsonGenerator */,
            param1: io.sentry.event.interfaces.HttpInterface
          ): void;
        }
      }
    }
      ...
      export namespace json {
        export class JsonMarshaller {
          ...
          public addInterfaceBinding(
            ...
            param1: io.sentry.marshaller.json.InterfaceBinding
          ): void;
          public constructor(param0: number);
        }
      }
    ...
    export namespace marshaller {
      export namespace json {
        export class MessageInterfaceBinding {
          ...
          public writeInterface(
            param0: any /* com.fasterxml.jackson.core.JsonGenerator */,
            param1: io.sentry.event.interfaces.MessageInterface
          ): void;
          public constructor(param0: number);
        }
      }
    ...
    export namespace marshaller {
      export namespace json {
        export class SentryJsonGenerator {
          ...
          public setCodec(
            param0: any /* com.fasterxml.jackson.core.ObjectCodec */
          ): any /* com.fasterxml.jackson.core.JsonGenerator */;
          ...
          public enable(
            param0: any /* com.fasterxml.jackson.core.JsonGeneratorFeature */
          ): any /* com.fasterxml.jackson.core.JsonGenerator */;
          ...
          public writeBinary(
            param0: any /* com.fasterxml.jackson.core.Base64Variant */,
    ...
    export namespace marshaller {
      export namespace json {
        export class StackTraceInterfaceBinding {
          ...
          public writeInterface(
            param0: any /* com.fasterxml.jackson.core.JsonGenerator */,
            param1: io.sentry.event.interfaces.StackTraceInterface
          ): void;
          public constructor();
        }
      }
    ...
    export namespace marshaller {
      export namespace json {
        export class UserInterfaceBinding {
          ...
          public writeInterface(
            param0: any /* com.fasterxml.jackson.core.JsonGenerator */,
            param1: io.sentry.event.interfaces.UserInterface
          ): void;
        }
      }
    }
